            ...
            <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
                <div className="headerList">
                    <div className="headerListItem active">
                        <FontAwesomeIcon icon={faBed} fade />
                        <span>Stay</span>
                    </div>
                ...
                <p className="headerDesc">Reward for you - unlock instant saving of 10% or more with a free Booking app </p>
                <button className="headerBtn">Sigin</button>

                <div className="search__above">
                    Search your destination  <FontAwesomeIcon style={{color:"orange"}} icon={faHotel} bounce size="xl" />
                </div>
